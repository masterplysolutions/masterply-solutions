...
import bgHeroAbout from '../../assets/bg-hero-about.png';
      ...
      <div className="bg-canvas flex flex-col justify-center px-6 py-24 md:py-32 md:px-16 lg:px-20 xl:px-24">
        <div className="max-w-[580px] w-full mx-auto lg:mx-0 flex flex-col gap-8 items-start">
          ...
          <div className="flex flex-col gap-4">
            ...
            >
              Não nascemos para vender madeira.{' '}
              <span className="text-secondary block md:inline">
                Nascemos para garantir que projetos não falham.
              </span>
            </motion.h1>
            ...
            >
              A Masterply Solutions foi fundada com um propósito claro: atuar
              onde o fornecimento comum não é suficiente. Onde o projeto exige
              parceiro, não apenas material.
            </motion.p>
          </div>
